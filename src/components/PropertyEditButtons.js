...
const PropertyEditButtons = ({propertyListing, setIsNotEditable, updateRecord, deleteRecord, updateProperty}) => {
  return (
    <div>
    <button onClick={() => {updateProperty(propertyListing.id, propertyListing)}} className="btn btn-sm btn-warning m-2">Save</button>
